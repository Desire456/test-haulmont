...
public class AddPatientWindow extends Window {
    ...
    public AddPatientWindow() {
        super(ViewConstants.ADD_PATIENT_WINDOW_CAPTION);
        setModal(true);
        ...
        save = new Button(ViewConstants.OK_BUTTON_CAPTION);
        ...
        save.addClickListener(event -> {
            ...
            String telephoneNumber = this.telephoneNumber.getValue();

            Patient toSave = new Patient(firstName, lastName, patronymic, telephoneNumber);
